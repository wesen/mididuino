...
public class CreatePatchFileEditor extends JDialog {

    private static Log log = LogFactory.getLog(CreatePatchFileEditor.class);
    ...
    public PatchFileBuilder createPatchFileBuilder() {
        ...
        builder.setSourceCodeDir(getSourcecodeFile());
