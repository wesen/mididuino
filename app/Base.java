...
//    }
      ...
      if (menubar != null) {
        ...
        if (System.getProperty("os.version").startsWith("10.4")) {
          ...
          String warning =
            ...
            "<p>Due to an Apple bug, the " + Base.PROGRAM_NAME + " menu bar " +
    ...
    try {
      ...
      System.err.println("Non-fatal error while setting the Look & Feel.");
      System.err.println("The error message follows, however " + Base.PROGRAM_NAME + " should run fine.");
      System.err.println(e.getMessage());
      //e.printStackTrace();
    }
  ...
  static protected void initRequirements() {
    try {
      ...
      Base.showError("Please install JDK 1.5 or later",
                     Base.PROGRAM_NAME + " requires a full JDK (not just a JRE)\n" +
    ...
    if (sketchbookPath != null) {
      ...
      if (!skechbookFolder.exists()) {
        Base.showWarning("Sketchbook folder disappeared",
                         ...
                         Base.PROGRAM_NAME + " will switch to the default sketchbook\n" +
                         "location, and create a new sketchbook folder if\n" +
                         "necessary. " + Base.PROGRAM_NAME + " will then stop talking about\n" +
...
//      return false;
  ...
  public void handleOpenPrompt() {
    ...
    FileDialog fd = new FileDialog(activeEditor,
                                   "Open an " + Base.PROGRAM_NAME + " sketch...",
                                   FileDialog.LOAD);
...
//          (editor.untitled && !editor.getSketch().isModified())) {
      if (Base.isMacOS()) {
        ...
        String prompt =
          ...
          "<p>Closing the last open sketch will quit " + Base.PROGRAM_NAME + ".";
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if (new File(path).exists()) {
            ...
            showWarning("Sketch Does Not Exist",
                        ...
                        "You may need to restart " + Base.PROGRAM_NAME + " to update\n" +
...
//  }
    ...
    if (preferencesPath != null) {
      ...
      try {
        ...
        showError("Problem getting data folder",
                  "Error getting the " + Base.PROGRAM_NAME + " data folder.", e);
      }
    }
    ...
    if (!settingsFolder.exists()) {
      if (!settingsFolder.mkdirs()) {
        showError("Settings issues",
                  Base.PROGRAM_NAME + " cannot run because it could not\n" +
  ...
  static public String getAvrBasePath() {
    if(Base.isLinux()) {
      ...
      return getToolsPath() + File.separator + "avr" + File.separator + "bin" + File.separator;
    }  
  }
