...
public class Platform extends processing.app.Platform {
  ...
  public File getSettingsFolder() throws Exception {
    return new File(getLibraryFolder(), Base.PROGRAM_NAME);
  }


  public File getDefaultSketchbookFolder() throws Exception {
    return new File(getDocumentsFolder(), Base.PROGRAM_NAME);
    /*
    ...
    try {
      ...
      sketchbookFolder = new File(documentsPath, Base.PROGRAM_NAME);
