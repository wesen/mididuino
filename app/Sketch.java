...
public class Sketch {
  ...
  public void addImportedLibrary(String item) {
    LibraryManager libraryManager;
    try {
      libraryManager = new LibraryManager();
      Library library = libraryManager.getLibraryWithFile(item);
      if (library != null) {
        File libFolder = library.getFolder();
  ...
  throws RunnerException {
    ...
    if (Preferences.get("boards." + board + ".upload.protocol").equals("midisend")) {
      System.out.println("Uploading over MIDI");
      uploader = new MidiUploader();
    } else {
