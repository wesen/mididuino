...
/**
 * Decode a MNMGlobal message from a sysex buffer.
 **/
...
/**
 * Encode a MNM Global message to a sysex buffer.
 *
...
/**
 * Decode a MNM Kit message from a sysex buffer.
 **/
