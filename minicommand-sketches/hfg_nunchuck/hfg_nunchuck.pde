...
// sda = analog pin 4
// scl = analog pin 5
#define pwrpin PORTC3 // analog pin 3
#define gndpin PORTC2 // analog pin 2

void nunchuckInit() {
  // Initialisierung der Stromversorugnspins
  DDRC |= _BV(pwrpin) | _BV(gndpin);
  PORTC &=~ _BV(gndpin);
  PORTC |= _BV(pwrpin);
  delay(100); 

  // Initialisieren der Wire-Bibliothek und Initialisieren des Nunchucks
  Wire.begin();
